                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{route('profile.edit',Auth::id())}}">Profile settings</a>
        ...
        @if(!in_array(request()->path(),['login','register','password/email','password/reset']))
                    <main class="py-4">
                        <div class="row">
                            <div class="col-4">
                                @auth
                                    <a href="{{route('discussions.create')}}" class="btn btn-info my-2 text-white w-100">Create
                                        discussion</a>
                                @else
